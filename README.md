...
public class pregunta1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("El sistema electoral para determinar las personas que ocuparan cargos publicos:");

        jButton1.setText("a) Sufragio");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
...
public class pregunta2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Una persona famelica esta:");

        jButton1.setText("a) Irritable");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
 ...
 * @author STELIDA
 */
public class primerSeguro extends javax.swing.JFrame {

    /**
     * Creates new form primerSeguro
     */
    public primerSeguro() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Llegaste bien a la primera ronda; has asegurado $1'000.000");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(primerSeguro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(primerSeguro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(primerSeguro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new primerSeguro().setVisible(true);
            }
        });
    }
